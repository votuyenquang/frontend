       ...
       <Layout className="layout">
        <div className="header-nav">
          ...
          <div className="topbar" >
              <span  style={{ color:'white',alignItems:'center' }}> <BiMap style={{fontSize:20,paddingTop:8}}/> 450 Trần Đại Nghĩa | <HistoryOutlined /> 08:00 - 17:00 | <PhoneOutlined /> 0705982473</span>
          </div>
          {Top()}
          {Navigation()}
        </div>
